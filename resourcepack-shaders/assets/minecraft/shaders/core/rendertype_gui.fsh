...
#define CHARSCALE 2
#define CHARCOUNT 22
#define STRING uint[](_V, _A, _N, _I, _L, _L, _A, _SPACE, _B, _E, _N, _V, _SPACE, _3, _DOT, _1, _SPACE, _A, _L, _P, _H, _A)
...
void main() {
    ...
    if (length(color.rgb - vec3(16 / 255.0)) < 0.001 || length(color.rgb - vec3(239.0 / 255.0, 50.0 / 255.0, 61.0 / 255.0)) < 0.001) {
